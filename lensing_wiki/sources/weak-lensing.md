---
title: Sources — weak gravitational lensing
type: sources
topics: [weak-lensing, shape-measurement]
status: stub
---

# Sources: weak gravitational lensing

Papers on weak gravitational lensing — cosmic shear, galaxy-galaxy
lensing, PSF / shape-measurement methodology. Distinct from the
strong-lensing-only material in `sources-lens-modeling-methods.md`
and `sources-cluster-lensing.md`.
...
- `../cti_wiki/sources/cti-shape-bias.md`
