---
title: Sources — medical imaging / cross-domain methods
type: sources
topics: [methods, medical-imaging]
status: stub
---

# Sources: medical imaging adjacents

A small collection of cross-domain method papers from the `Medical/`
folder — kept here because the underlying methodology (Bayesian
inversion, deep learning) overlaps with PyAuto-style work, even though
the application domain (cancer / clinical imaging) is well off-topic
for lensing.
...
- [[deep-learning-astro]]
- (off-topic for lensing/cosmology — pure methods reference)
