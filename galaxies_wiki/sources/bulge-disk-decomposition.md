...
type: sources
topics: [bulge-disk-decomposition, morphology]
status: stub
---

# Sources: bulge-disk decomposition

Papers on 2D image decomposition of galaxies into bulge + disk (+ bar,
+ halo) components — the methodology underlying PyAutoLens lens-light
models.
...
- [[../lensing_wiki/sources-bulge-halo]]
