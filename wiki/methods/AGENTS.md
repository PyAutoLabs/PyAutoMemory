...
scientific-software ecosystem. Sibling of `../lensing/` under
...
```
methods/
├── AGENTS.md           # this file — schema + scope
...
Inherits verbatim from [`../AGENTS.md`](../AGENTS.md).
...
- `Deep Learning/` — CNNs, BNNs, simulation-based inference applied
  to astrophysics (cross-references `../lensing/sources-deep-learning-lensing.md`).
...
- Lens-modelling-specific Bayesian / regularisation methods —
  `../lensing/concepts/bayesian-inference-lensing.md` and
  `../lensing/concepts/regularization.md`.
- Mass-model / source-reconstruction software entities —
  `../lensing/entities/{pyautolens,pyautofit,lenstronomy}.md`.

## How the assistant should use this wiki

Same protocol as `../AGENTS.md`.
