---
title: Sources — elliptical galaxies
type: sources
...
General-population elliptical-galaxy papers separate from the MASSIVE-
survey-specific work in [[sources-massive-ellipticals]].
...
**Concepts:** [[etg-structure]] (cross-link `../lensing/`)
...
- Provides citable context for [[etg-structure]] (cross-link `../lensing/`) when the claim is limited to that verified scope.
