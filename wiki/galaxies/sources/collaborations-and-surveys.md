---
title: Sources — collaborations and surveys
type: sources
topics: [surveys, collaborations]
status: stub
---

# Sources: collaborations and surveys

Survey overview / instrument papers from the `Collaborations/` folder.
...
**Canonical BibTeX key:** TODO — no unique match found in `bibliography/pyautomemory.bib`.
**Reference:** TODO — identify the public paper record and add or resolve the canonical BibTeX key.
**Concepts:** none specific (cross-link `../lensing/sources/weak-lensing.md`)
