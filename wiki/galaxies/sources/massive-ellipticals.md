---
title: Sources — massive ellipticals
type: sources
topics: [etg-structure, massive-ellipticals]
status: stub
---

# Sources: massive ellipticals

Papers concentrating on the most massive early-type galaxies (the
MASSIVE survey targets, BCGs, and similar log M ≳ 11.5 ETGs). These
are the typical hosts of strong-lens galaxies, so their structure
matters directly for PyAutoLens priors.
